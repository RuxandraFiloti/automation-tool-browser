...
class App:
    def __init__(self, root):
        ...
        self.entry_password = tk.Entry(self.login_frame, show="*")  # show="*" hides the password input
        ...
        tk.Label(self.form_frame, text="Full Name").grid(row=0, column=0, sticky="w") #sticky="w" aligns the label to the left -> west
        self.entry_full_name = tk.Entry(self.form_frame)
        self.entry_full_name.grid(row=0, column=1, sticky="ew")

        tk.Label(self.form_frame, text="Email").grid(row=1, column=0, sticky="w") #sticky="w" aligns the label to the left -> west
        self.entry_email = tk.Entry(self.form_frame)
        self.entry_email.grid(row=1, column=1, sticky="ew")

        tk.Label(self.form_frame, text="Current Address").grid(row=2, column=0, sticky="w") #sticky="w" aligns the label to the left -> west
        self.entry_current_address = tk.Entry(self.form_frame)
        self.entry_current_address.grid(row=2, column=1, sticky="ew")

        tk.Label(self.form_frame, text="Permanent Address").grid(row=3, column=0, sticky="w") #sticky="w" aligns the label to the left -> west
